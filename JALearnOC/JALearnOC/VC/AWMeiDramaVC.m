...
@interface AWMeiDramaVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>{
...
-(void)getDramaListMethod
{
    ...
    [[AWNetworkManager sharedInstance] getWithURLString:[NSString stringWithFormat:@"%@%@",MLGB_API_URL,VIDEO_LIST_API] parameters:@{@"type":@"mj"} success:^(id  _Nonnull responseObject) {
