...
- (void)positionHUD:(NSNotification*)notification {
...
#if TARGET_OS_IOS
    UIInterfaceOrientation orientation = CGRectGetWidth(self.frame) > CGRectGetHeight(self.frame) ? (UIInterfaceOrientationLandscapeLeft || UIInterfaceOrientationLandscapeRight) : UIInterfaceOrientationPortrait;
#endif
#endif
    ...
    NSLog(@"this frame is %@",NSStringFromCGRect(orientationFrame));
